...
<head>
    ...
    <link rel="stylesheet" href="../style/room_detail.css">
...
<div class="container">
    ...
    <div class="details">
        ...
        <a href="<?= htmlspecialchars($room['hotel_address_link']) ?>" target="_blank"
           class="map-link">View on Google Maps → <i class="fa-solid fa-location-dot"></i></a>
